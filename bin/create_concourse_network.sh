...
aws s3 cp s3://eng2-states/concourse/tfstate.json "${CONCOURSE_TERRAFORM_STATE_FILE}" ||
...
aws s3 cp "${CONCOURSE_TERRAFORM_STATE_FILE}" s3://eng2-states/concourse/tfstate.json
